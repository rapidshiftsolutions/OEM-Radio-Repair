...
export const metadata = {
  title: 'Blog - OEM Radio Repair',
  description:
    'Explore the latest updates, insights, and stories from OEM Radio Repair on land management, innovative technologies, and sustainable solutions.',
}
    ...
    <main className="overflow-hidden">
      ...
      <Container>
        ...
        <Heading as="h1" className="mt-2">
          What’s happening at OEM Radio Repair.
        </Heading>
        <Lead className="mt-6 max-w-3xl">
          Stay informed with product updates, company news, and insights on land management, innovative technologies, and sustainable solutions.
        </Lead>
      </Container>
